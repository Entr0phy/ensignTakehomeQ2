...
const ProductPage = () => {
  ...
  return (
    <div className=" flex flex-col max-w-6xl mx-auto justify-center items-center bg-white p-2 rounded shadow">
      ...
      <h1 className="font-bold text-l mx-2 text-orange-400">
      ...
      <Link to="/component/cart">
        <button
          onClick={addToCart}
          className="p-2 m-2 bg-orange-600 rounded-full text-rose-50 font-bold">
          Add To Cart
        </button>
      </Link>
    </div>
